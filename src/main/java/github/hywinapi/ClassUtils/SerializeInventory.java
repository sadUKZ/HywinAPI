...
public class SerializeInventory {
    ...
    public static String serialize(Inventory inventory, String inventoryName) {
        StringBuilder serialized = new StringBuilder(String.format("%s;%s==", inventoryName, inventory.getSize()));
